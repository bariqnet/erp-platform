...
| [0002](./0002-better-auth-zod-4-deferral.md) | Better Auth Integration Deferred Pending Zod 4 | Partly superseded by ADR-0003 | TASK-10.1  |
| [0003](./0003-zod-4-migration.md)            | Zod 4 Migration                                | Accepted                      | TASK-10.1a |
...
the Zod 4 migration path for TASK-10.1. ADR-0003 records the
completed Zod 4 migration half of TASK-10.1 (TASK-10.1a); Better
Auth wiring (TASK-10.1b) is the remaining work.
